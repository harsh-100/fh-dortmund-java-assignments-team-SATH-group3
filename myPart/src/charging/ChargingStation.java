...
public class ChargingStation implements IGridEntity {
	...
	public ChargingStation(Point location) {
		...
		try {
            this.logManager = new LogManager("/Users/artemrymar/Desktop/MDT/Java compact course /PreparatoryJavaCourse/fh-dortmund-java-assignments-team-SATH-group3/myPart/ChargingStationLogs");
        } catch (Exception e) {
